...
test_data.drop(test_data[test_data['duration_ms'] == -1].index, inplace=True)
test_data.drop(test_data[test_data['tempo'] == "?"].index, inplace=True)
test_data.drop(test_data[test_data['popularity'] == 0].index, inplace=True)
